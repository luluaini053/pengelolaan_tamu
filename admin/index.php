    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        chart1 = new Highcharts.Chart({
          ...
          series: [
            <?php
            $sql   = "SELECT distinct MONTH(tanggal) as bulan FROM buku_tamu ORDER BY 1 ASC";
            $query = mysql_query($sql)  or die(mysql_error());
            while (list($bulan) = mysql_fetch_array($query)) {
              $sql_jumlah   = "SELECT count(id_tamu) as jumlah FROM buku_tamu WHERE MONTH(tanggal)='$bulan'";
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        chart2 = new Highcharts.Chart({
          ...
          series: [
            <?php
            $sql   = "SELECT distinct MONTH(tanggal) as bulan FROM keluhan_pelanggan ORDER BY 1 ASC";
            $query = mysql_query($sql)  or die(mysql_error());
            while (list($bulan) = mysql_fetch_array($query)) {
              $sql_jumlah   = "SELECT count(id_keluhan) as jumlah FROM keluhan_pelanggan WHERE MONTH(tanggal)='$bulan'";
              $query_jumlah = mysql_query($sql_jumlah) or die(mysql_error());
              switch ($bulan) {
                case "01";
                  $bulan = "Januari";
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="row">
          <?php
          $sql_tamu   = "SELECT count(id_tamu) as jumlah FROM buku_tamu";
          $query_tamu = mysql_query($sql_tamu) or die(mysql_error());
          $row_tamu = mysql_fetch_array($query_tamu);

          $sql_keluhan   = "SELECT count(id_keluhan) as jumlah FROM keluhan_pelanggan";
          $query_keluhan = mysql_query($sql_keluhan) or die(mysql_error());
          $row_keluhan = mysql_fetch_array($query_keluhan);

          $sql_kebutuhan   = "SELECT count(id_kebutuhan) as jumlah FROM identifikasi_kebutuhan_pelanggan";
          $query_kebutuhan = mysql_query($sql_kebutuhan) or die(mysql_error());
          $row_kebutuhan = mysql_fetch_array($query_kebutuhan);
          ?>
          <div class="col-xl-4 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5"><?php echo $row_tamu['jumlah']; ?> Data Tamu</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="buku-tamu.php">
          ...
          <div class="col-xl-4 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5"><?php echo $row_keluhan['jumlah']; ?> Data Keluhan Pelanggan</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="keluhan-pelanggan.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fa fa-angle-right"></i>
                </span>
          ...
          <div class="col-xl-4 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5"><?php echo $row_kebutuhan['jumlah']; ?> Data Identifikasi Kebutuhan Pelanggan</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="identifikasi-kebutuhan-pelanggan.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fa fa-angle-right"></i>
                </span>
